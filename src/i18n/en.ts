...
When done, display the site's public URL.`,
      ...
      i18n: {
        ...
        callout: 'The admin pages (<code class="inline-code">/notas/admin</code>, <code class="inline-code">/notas/new</code>) remain in Portuguese — they are internal areas with no need for internationalization. The APIs were also not changed.',
      },
    },
  },
